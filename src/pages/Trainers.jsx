...
import TrainersDeck from '../components/Trainers';
      ...
      <div className="max-w-7xl mx-auto px-6 md:px-12 text-center mb-16 relative">
        ...
        >
          ...
          <p className="text-rawMuted text-base sm:text-lg max-w-2xl mx-auto mt-4 font-inter leading-relaxed">
            Our trainers hold accredited sports science degrees, professional athlete credentials, and certified strength titles to safely push your biological parameters.
          </p>
        </motion.div>
      </div>
